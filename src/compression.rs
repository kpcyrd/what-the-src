...
mod tests {
    ...
    async fn test_bz2() {
        let data = [
            0x42, 0x5a, 0x68, 0x39, 0x31, 0x41, 0x59, 0x26, 0x53, 0x59, 0x0d, 0xee, 0x40, 0xd3,
            0x00, 0x00, 0x76, 0xfb, 0x80, 0xca, 0x90, 0x40, 0x00, 0x60, 0x01, 0x5d, 0x80, 0x00,
            0x40, 0x64, 0xe5, 0x9e, 0xc0, 0x04, 0x08, 0x20, 0x00, 0x54, 0x34, 0x90, 0x3d, 0x40,
            0xd0, 0xd0, 0xf5, 0x0d, 0xa8, 0x3c, 0xa0, 0x92, 0x89, 0x91, 0x90, 0x00, 0xd0, 0x00,
            0x7d, 0xd5, 0x51, 0x99, 0x08, 0x20, 0xf4, 0x21, 0x0e, 0xb6, 0x82, 0xca, 0x5c, 0xf4,
            0x08, 0x60, 0x56, 0xd8, 0xf2, 0xd9, 0x6d, 0xc3, 0x1f, 0x94, 0x12, 0x52, 0x32, 0x14,
            0x61, 0x24, 0xcc, 0xd0, 0xce, 0x02, 0xe9, 0x89, 0xa2, 0xaf, 0x62, 0x05, 0xb4, 0x9d,
            0x5a, 0xbb, 0x19, 0xdd, 0x9f, 0x4c, 0xa4, 0x44, 0x40, 0x7e, 0x2e, 0xe4, 0x8a, 0x70,
            0xa1, 0x20, 0x1b, 0xdc, 0x81, 0xa6,
        ];
        let reader = auto(&data[..]).await.unwrap();
        assert_eq!(reader.outer_label(), "bz2(tar)");
        verify_tar(reader).await;
    }
